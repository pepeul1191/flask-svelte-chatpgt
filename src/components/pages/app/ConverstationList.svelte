<script>
  ...
  <div class="mb-3">
    ...
    <a href="/conversations/new" on:click|preventDefault={() => navigate(`/conversations/new`)} class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i>Nueva Conversación</a>
  </div>
  <!-- Table Element -->
